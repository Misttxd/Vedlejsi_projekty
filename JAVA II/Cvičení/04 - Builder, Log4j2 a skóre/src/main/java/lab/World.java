...
public class World {
    ...
    private final List<DestroyedUfo> destructionRecords = new ArrayList<>();
    ...
    public void recordUfoDestruction(Point2D position) {
        destructionRecords.add(new DestroyedUfo(LocalDateTime.now(), position));
    }
    public void printDestructions() {
        System.out.println("--- Záznamy o zničení UFO ---");
        destructionRecords.forEach(System.out::println);
    }

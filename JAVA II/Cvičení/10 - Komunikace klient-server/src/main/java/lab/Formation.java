...
public abstract class Formation<T extends DrawableSimulable> extends WorldEntity implements Collisionable, Serializable {
    @Serial
    private static final long serialVersionUID = 1L;

    protected final List<T> entitiesInFormation;
    private MyPoint speed = new MyPoint(20, 0);

    public Formation(World world, MyPoint position, T... entities){

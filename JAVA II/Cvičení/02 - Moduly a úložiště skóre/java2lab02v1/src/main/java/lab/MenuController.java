...
public class MenuController {
    ...
    void onBtnGenerateTen(ActionEvent event) {
        ...
        try {
            ScoreStorageFactory.getInstance().save(generatedScores);
            updateTable();
    ...
    void onBtnGenerateOne(ActionEvent event) {
        try {
            ScoreStorageFactory.getInstance().save(Utilities.generate());
            updateTable();
        } catch (ScoreException e) {
    ...
    void onBtnDelete(ActionEvent event) {
        try {
            ...
            ScoreStorageFactory.getInstance().delete(score);
            updateTable();
        } catch (ScoreException e) {
    ...
    private void updateTable() {
        ...
        try {
            scoreTable.getItems().addAll(ScoreStorageFactory.getInstance().load());
        } catch (ScoreException e) {

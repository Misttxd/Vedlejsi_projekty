...
public class Level {
    ...
    private final rhytmGame.mapDataManagement.Difficulty difficulty;
    ...
    public Level(double width, double height, rhytmGame.mapDataManagement.Difficulty difficulty, MapInfo map, MediaPlayer mediaPlayer) {
    ...
    public void checkRelease(int lane) {
        ...
        Note releaseNote = entities.stream()
    ...
    public rhytmGame.mapDataManagement.Difficulty getDifficulty() {
        return difficulty;
    }
    ...
    private void fireGameFinished() {
        ...
        listeners.forEach(l -> l.onGameFinished(stats));
    }

    private void fireComboChanged(int newCombo) {
        int comboMultiplier = getComboMultiplier();
        listeners.forEach(l -> l.onComboChanged(newCombo, comboMultiplier, overdriveActive));
    }

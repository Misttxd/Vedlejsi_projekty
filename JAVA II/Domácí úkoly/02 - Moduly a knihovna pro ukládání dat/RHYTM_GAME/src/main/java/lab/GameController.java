...
public class GameController {
    ...
    private Level level;
    private rhytmGame.mapDataManagement.MapInfo currentMap;
    ...
    public void startGame(MapInfo map) {
        ...
        rhytmGame.mapDataManagement.Difficulty difficulty = rhytmGame.mapDataManagement.Difficulty.fromDisplayName(currentMap.getDifficulty());
        ...
        level.addListener(new GameEventListener() {
            ...
            public void onGameFinished(GameStats stats) {
                ...
                javafx.application.Platform.runLater(() -> {
                    ...
                    try {
                        rhytmGame.mapDataManagement.MapRepository.saveScore(currentMap.getId(), name, finalScore);
